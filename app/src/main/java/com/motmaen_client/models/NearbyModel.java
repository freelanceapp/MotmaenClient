...
public class NearbyModel implements Serializable {
    ...
    public static class Result implements Serializable{
        ...
        public Result(String id, String icon, String name, String place_id, double rating, String vicinity, List<Photo> photos, Geometry geometry, List<String> types, double distance, boolean isOpen, PlaceDetailsModel.Opening_Hours work_hours, List<PhotosModel> photosModels, List<PlaceDetailsModel.Reviews> reviews) {
            this.id = id;
            this.icon = icon;
            this.name = name;
